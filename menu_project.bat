...
echo 2. Detect repeat in all sub folders - Picture (Percentage)
echo 3. Change format in all sub folders - Picture (JPG)
echo 4. Change format in all sub folders - Picture (JPEG)
echo 5. Delete repeat in all sub folders - Video
echo 6. Change format in all sub folders - Video
echo 7. Detect (Folders, Sub folders, Files).
echo 8. Detect (Folders, Sub folders).
